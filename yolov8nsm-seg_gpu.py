...
# load YOLOv8n-seg
# model = YOLO('yolov8n-seg.pt').to('cuda')  # transfer the model to GPU
# load YOLOv8s-seg
# model = YOLO('yolov8s-seg.pt').to('cuda')  # transfer the model to GPU
# load YOLOv8m-seg
model = YOLO('yolov8m-seg.pt').to('cuda')  # transfer the model to GPU
